...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //attemptLogin();
                 if(mEmailView.getText().toString().equals("ecounselling")){
                     if(mPasswordView.getText().toString().equals("password")){
                         startActivity(new Intent(LoginActivity.this,MainActivity.class));

                     }
                 }
                 else if(mEmailView.getText().toString().equals("") && mPasswordView.getText().toString().equals("")){
    ...
    public void registrationScreen(View v) {
